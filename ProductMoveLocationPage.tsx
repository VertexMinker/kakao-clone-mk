...
const ProductMoveLocationPage = () => {
  ...
  const moveMutation = useMutation({
    mutationFn: (data: { productId: string; toLocation: string }) => 
      productService.moveLocation(data.productId, { toLocation: data.toLocation }),
    onSuccess: () => {
        ...
        <div className="border-t border-gray-200 px-4 py-5 sm:p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-yellow-700">
                      <p>
                        현재 오프라인 상태입니다. 위치 변경 작업은 저장되며, 온라인 연결 시 자동으로 동기화됩니다.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex justify-end">
              ...
              <button
                type="submit"
                disabled={isSubmitting || !toLocation || product.location === toLocation}
